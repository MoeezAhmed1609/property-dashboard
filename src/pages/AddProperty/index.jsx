...
const AddProperty = () => {
    ...
    const HandeSubmitForm = async (event) => {
        ...
        console.log(urls);
        console.log(AboutProjectAndProperties);
        console.log(PaymentPlanAndInformation);
        console.log(LoactionPlanIn);
                                ...
                                <form onSubmit={HandeSubmitForm}>
                                    ...
                                    <Box className='mb-5.5'>
                                        ...
                                        <Input
                                            ...
                                            type='text'
                                            name='Username'
                                            onChange={(e) => setPaymentPlanAndInformation(e.target.value)}
                                            placeholder='devidjhon24'
                                    ...
                                    <Box className='mb-5.5'>
                                        ...
                                        <Box className='relative'>
                                            ...
                                            <textarea
                                                ...
                                                id='bio'
                                                rows='6'
                                                onChange={(e) => setAboutProjectAndProperties(e.target.value)}
                                                placeholder='Write your bio here'
                                            ></textarea>
                                        </Box>
                                    </Box>
