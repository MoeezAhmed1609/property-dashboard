...
import { AiOutlineFileImage, AiOutlineFolderView, AiOutlineLock, AiOutlinePhone, AiOutlineUserAdd } from 'react-icons/ai';
    ...
    <React.Fragment>
      <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark overflow-y-hidden'>
        <div className='flex flex-wrap items-center'>
          ...
          <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 max-h-screen overflow-y-auto'>
