...
export default function Register() {
    ...
    return (
        <>
            <Box className="min-h-screen bg-gray-100 flex items-center justify-center bg-boxdark overflow-y-auto">
                ...
                <Box className="bg-white p-5 shadow-md rounded-md w-full max-w-md max-h-[96vh] overflow-y-auto">
                    <Text as={'h1'} className="text-2xl font-bold mb-6">Register</Text>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-boxdark  hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300"
                        >
                            Register
                        </Button>
                    </form>
